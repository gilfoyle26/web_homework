...
<body>
	...
	<nav class="navbar navbar-expand-sm fixed-top navbar-white">
		...
		<div class="container">
			...
			<div id="navbarCollapse" class="collapse navbar-collapse">
				<ul class="navbar-nav ml-auto ">
					...
					<li class="nav-item">
						<a href="eskisehir.html" class="nav-link active  text-white">
						Eskişehir
						</a></li>		
	...
	<header>
		...
		<div class="text-light jumbotron desc-color">
		...
		<div class="container">
			...
			<form action="git-Login.php" method="POST">
				...
				<div class="form-group">
					...
					<input type="text" name="email" class="form-control" placeholder="Email 'sami.acar@ogr.sakarya.edu.tr'" required="required">
				</div>
	...
	<footer class="py-2 text-white text-center">
		Web-Teknolojileri-Projesi © Sami Çağlar Acar 2021
	</footer>
